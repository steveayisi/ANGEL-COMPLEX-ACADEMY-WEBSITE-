  ...
  const clubs = [
    {
      name: "Science Club",
      description:
        "Explore the wonders of science through experiments, observations, and discovery.",
      icon: Zap,
    ...
    },
    {
      ...
      description:
        "Develop problem-solving skills and explore the beauty of mathematics.",
      icon: Calculator,
    ...
    },
    {
      name: "Reading Club",
      description:
        "Foster a love for reading and improve literacy skills through shared literary experiences.",
      icon: BookOpen,
    ...
    },
    {
      name: "Art & Craft Club",
      description:
        "Express creativity through various art forms and craft projects.",
      icon: Palette,
    ...
    },
    {
      name: "Music Club",
      description:
        "Develop musical talents through singing, playing instruments, and music appreciation.",
      icon: Music,
    ...
    },
    {
      ...
      description:
        "Promote environmental awareness and sustainable practices within the school community.",
      icon: Globe,
      color: "bg-green-100 text-green-600",
      members: 22,
      meetingDay: "Wednesdays",
    ...
    },
    {
      name: "Sports Club",
      description:
        "Develop athletic skills and promote physical fitness through various sports activities.",
      icon: Trophy,
    ...
    },
    {
      name: "Debate Club",
      description:
        "Enhance public speaking skills and critical thinking through structured debates.",
      icon: Users,
    ...
    },
    {
      ...
      description:
        "Engage in community service activities and develop social responsibility.",
      icon: Heart,
    ...
    <div className="bg-white">
      ...
      <section className="relative py-40">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${clubsImage})`,
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              Discover and join our vibrant clubs that help students develop
              their talents, interests, and leadership skills beyond the
              classroom.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Choose from a variety of clubs to explore your interests and
              develop new skills
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Why extracurricular activities are important for your child's
              development
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Build friendships and learn teamwork through collaborative
                activities.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Develop leadership skills and take on responsibilities within
                the club.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Discover and nurture hidden talents and interests.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Build character, confidence, and personal values.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Browse our clubs and find one that matches your child's
                interests.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Complete the club registration form available at the school
                office.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Introduce your child to the club supervisor and understand
                expectations.
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Your child can start attending club meetings and activities.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20 bg-orange-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-orange-100">
            Help your child discover their passion and develop new skills
            through our diverse club offerings.
          </p>
