...
import { GraduationCap, Award, Book, Users, Star, Mail, Phone } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-purple-100 max-w-3xl mx-auto">
              Our dedicated team of qualified educators and support staff are committed 
              to providing the best educational experience for every child.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-8 mb-12">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-2">{headTeacher.name}</h3>
                <p className="text-lg text-blue-600 font-semibold mb-2">{headTeacher.title}</p>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {staff.subjects.map((subject, subIndex) => (
                        <span key={subIndex} className="bg-blue-100 text-blue-800 text-xs px-2 py-1 rounded">
                          {subject}
                        </span>
                      ))}
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {supportStaff.map((staff, index) => (
              <div key={index} className="text-center">
                ...
                <p className="text-purple-600 font-medium mb-2">{staff.title}</p>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100">
            Are you passionate about education? We're always looking for dedicated professionals to join our team.
          </p>
